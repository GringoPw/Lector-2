...
valores_por_defecto = {
    ...
    "TOTAL A PAGAR": "=[@ALGODÓN EN BRUTO TN]*[@PRECIOS]",
    "RINDE SEMILLA(KGRS)": "=[@ALGODÓN EN BRUTO TN]*0.45",
    ...
    "NETO FLETES":"=[@ALGODÓN EN BRUTO TN]*[@[TARIFA FLETES]]",
    "DESCUENTO (Fl+C)":"=+[@[IMPORTE A PAGAR CARGADOR]]+[@[NETO FLETES]]",
    "IMPORTE S/IVA": "=[@ALGODÓN EN BRUTO TN]*[@PRECIOS]"
